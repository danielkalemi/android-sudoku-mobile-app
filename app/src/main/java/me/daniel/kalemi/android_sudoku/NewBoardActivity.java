...
import me.daniel.kalemi.android_sudoku.fragments.CellGroupFragment;
import me.daniel.kalemi.android_sudoku.model.Board;
...
public class NewBoardActivity extends AppCompatActivity implements CellGroupFragment.OnFragmentInteractionListener {
    ...
    public void onFragmentInteraction(int groupId, int cellId, View view) {
        ...
        Intent intent = new Intent("me.daniel.kalemi.ChooseNumberActivity");
        intent.putExtra("newBoard", true);
