...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkCurrentLocale() {
        ...
        if (currentLanguage == null) {
            ...
            if (locale.getLanguage().equals("no") || locale.getLanguage().equals("nb") || locale.getLanguage().equals("nn")) {
                //Albanian is selected
                Log.i(TAG, "Albanian is selected");
    ...
    public void onStartNewGameButtonClicked(View view) {
        Intent intent = new Intent("me.daniel.kalemi.GameDifficultyActivity");
        startActivity(intent);
    }

    public void onAddNewBoardButtonClicked(View view) {
        Intent intent = new Intent("me.daniel.kalemi.NewBoardActivity");
        startActivity(intent);
    }

    public void onShowInstructionsButtonClicked(View view) {
        Intent intent = new Intent("me.daniel.kalemi.InstructionsActivity");
        startActivity(intent);
    }

    public void onNorwegianFlagClick(View view) {
        if (currentEnglish) {
            Log.i(TAG, "Albanian is now selected");
            SharedPreferences sharedPreferences = getDefaultSharedPreferences(this);
            SharedPreferences.Editor editor = sharedPreferences.edit();
            Resources resources = getBaseContext().getResources();
            Configuration configuration = new Configuration();
            ...
            Toast.makeText(this, "Pershendetje ne app", Toast.LENGTH_SHORT).show();
        } else {
            Log.i(TAG, "Albanian is already selected");
